...
export const weddingConfig: WeddingConfig = {
  couple: {
    bride: {
      firstName: "Nam",
      fullName: "Vũ Thị Nxxx",
      role: "bride",
      image: "/images/hero-wedding.png",
      description: "Dịu dàng, chân thành và luôn tìm thấy niềm vui trong những điều giản dị.",
      father: "Ông [Tên bố cô dâu]",
      mother: "Bà [Tên mẹ cô dâu]",
    },
    groom: {
      firstName: "Hào",
      fullName: "Lương Ngọc Hxxx",
      role: "groom",
      image: "/images/hero-wedding.png",
      description: "Điềm tĩnh, ấm áp và tin rằng những hành trình đẹp nhất luôn cần một người đồng hành.",
  ...
  hero: {
    image: "/images/hero-wedding.png",
    imageAlt: "Cô dâu và chú rể cùng bước đi trong khu vườn ngày cưới",
  ...
  site: {
    ...
    description: "Thiệp mời đám cười của Hào và Nam — Duyên quan họ Bắc Ninh.",
    locale: "vi_VN",
