...
export function Gallery({ images }: GalleryProps) {
  return (
    <section id="gallery" className="relative overflow-hidden bg-[var(--color-background)]">
      ...
      <header className="mx-auto grid w-full max-w-[var(--container-wide)] gap-10 px-[var(--page-gutter)] py-[var(--section-space-lg)] lg:grid-cols-[0.7fr_1.3fr] lg:gap-24">
        ...
        <Reveal className="border-t border-[var(--color-border)] pt-7" delay={0.1}>
          ...
          <p className="mt-12 max-w-xl leading-8 text-[var(--color-muted)]">
